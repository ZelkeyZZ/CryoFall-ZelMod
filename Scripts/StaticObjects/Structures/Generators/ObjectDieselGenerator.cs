namespace AtomicTorch.CBND.CoreMod.StaticObjects.Structures.Generators
{
    ...
    public class ObjectDieselGenerator : ProtoObjectGeneratorWithFuel
    {
        ...
        public override string Description =>
            "This large generator uses petrol fuel to produce electrical energy.";
        ...
        public override string Name => "Diesel Generator";
        ...
        protected override void ServerInitialize(ServerInitializeData data)
        {
            ...
            Server.Items.SetContainerType<ItemsContainerLiquidPetroleum>(
