namespace AtomicTorch.CBND.CoreMod.CraftRecipes
{
    ...
    public class RecipeDieselGeneratorEmptyCanisterFromPetroleumCanister : Recipe.RecipeForManufacturing
    {
        private ItemCanisterPetroleum inputItem;

        public override bool IsAutoUnlocked => true;

        public override string Name => "Add petrol from canister to diesel generator";
